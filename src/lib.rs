// src/lib.rs
/*
 * Core library for FinderPattern
 */
...
#[derive(Debug)]
pub struct FinderPatternProcessor {
    verbose: bool,
    processed_count: usize,
}

impl FinderPatternProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting FinderPattern processing");
    
    let mut processor = FinderPatternProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = FinderPatternProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = FinderPatternProcessor::new(false);
